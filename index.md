...
(NHS) Numbers from standard input. This page is a sitemap; for the user
guide start at [`docs/index.md`](./docs/index.md).
...
* **Issues & releases:** <https://github.com/GIG-Cymru-NHS-Wales/nhs-number-cli-using-rust/issues>.

## Privacy note

NHS Numbers are patient identifiers. Use only the synthetic test range
`999 000 0000`–`999 999 9999` in any artefact stored in this repository.
See [`examples/README.md`](./examples/README.md#about-the-test-numbers).
